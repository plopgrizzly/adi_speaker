...
use libc;
use libc::{ c_ulong, c_long, c_int, c_uint, size_t, c_void, c_char };
...
pub(crate) struct Context {
	...
	pub(crate) snd_pcm_hw_params_set_rate: unsafe extern "C" fn(pcm: *mut snd_pcm_t, params: *mut snd_pcm_hw_params_t, val: c_uint, dir: c_int) -> c_int,
	...
	pub(crate) snd_pcm_status: unsafe extern "C" fn(pcm: *mut snd_pcm_t, status: *mut snd_pcm_status_t) -> c_int,
	pub(crate) snd_pcm_open: unsafe extern "C" fn(pcm: *mut *mut snd_pcm_t, name: *const c_char, stream: snd_pcm_stream_t, mode: c_int) -> c_int,
	pub(crate) snd_pcm_recover: unsafe extern "C" fn(pcm: *mut snd_pcm_t, err: c_int, silent: c_int) -> c_int,
